...
class MyAboutPage1 extends StatefulWidget {
  final List locale = [
  ...
  MyAboutPage1({Key? key}) : super(key: key);

  @override
  State<MyAboutPage1> createState() => _MyAboutPageState();
}

class _MyAboutPageState extends State<MyAboutPage1> {
  @override
